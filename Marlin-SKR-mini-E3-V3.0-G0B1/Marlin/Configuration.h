...
#define STRING_CONFIG_H_AUTHOR "(Creality CR-10 MAX, piwniczana wersja, 07.04.2023, 2 w nocy, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Piwniczak"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 137.72 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 10, 35 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -24, -2, -2.75 }
